...
import { addJob, getAllJobs, getApprovedJobs, getCategoryJobs, getCompanyJobs, getCompanyJobsById, getJob, getJobBySlug, getPendingJobs, getSavedJobs, getSponsoredJobs, removeJob, searchJob, updateJobStatus } from '../controllers/jobsController.js'
...
jobsRouter.get('/getcompanyjobs/:companyId', getCompanyJobs);
