...
const CandidateCategoryManager = () => {
      ...
      reader.onload = async (e) => {
        try {
          ...
          const response = await axios.post(
            `${backendUrl}/api/admin/candidate-categories/bulk-import`,
  ...
  const downloadTemplate = () => {
    ...
    // Optionally add existing categories to template? No, just blank template usually better for import
    // But skills manager adds existing items. Let's replicate that behavior if user wants to export essentially.
    ...
    XLSX.writeFile(workbook, "candidate_categories_template.xlsx");
