      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between mt-6">
        <div className="flex items-center gap-2 text-sm text-gray-600">
          <select
            ...
            className="border border-gray-300 rounded-md px-3 py-2 focus:border-[var(--primary-color)] focus:ring-[var(--primary-color)]"
          >
        ...
        <div className="flex items-center gap-2 text-sm">
          <button
            ...
            className="p-1 border border-gray-300 rounded-full hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed"
          >
            <ChevronLeft />
          </button>
          {(() => {
